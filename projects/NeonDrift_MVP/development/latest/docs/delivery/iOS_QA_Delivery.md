...
- 專案: NeonDrift_MVP
- run_id: notion-NeonDrift_MVP-qa-qa-full-20260626143240
- 交付狀態: blocked
- QA 狀態: failed
...
- checks_failed: 10
- checks_blocked: 0
- bundle_id: com.DefaultCompany.NeonDrift.run.1782484282.54413

## iOS Simulator App

- app_path: `/home/node/.openclaw/workspace/382b9e3384298039b171c9b2a60ae644/NeonDrift_MVP/project/xcode_derived_data/Build/Products/Release-iphonesimulator/NeonDrift.run.1782484282.54413.app`

## Install And Launch

```bash
xcrun simctl install booted /Users/dragonkao/.openclaw/workspace/382b9e3384298039b171c9b2a60ae644/NeonDrift_MVP/project/xcode_derived_data/Build/Products/Release-iphonesimulator/NeonDrift.run.1782484282.54413.app
xcrun simctl launch booted com.DefaultCompany.NeonDrift.run.1782484282.54413
```
...
- qa_menu_human_readability_gate: menuVisualMetrics={'exists': True, 'width': 1206, 'height': 2622, 'sample_count': 40000, 'min_luma': 0.0, 'max_luma': 31.072, 'mean_luma': 30.702, 'dark_ratio': 0.012, 'bright_ratio': 0.0, 'very_bright_ratio': 0.0, 'saturated_color_ratio': 0.0, 'color_bucket_count': 3}, menuHumanReadable=False.
- qa_game_over_visual_state_gate: gameOverProbePresent=True, screenState='game_over', isGameOver=True, gameOverPanelVisible=True, gameplayToGameOver={'comparable': True, 'mean_abs_diff': 0.937, 'changed_ratio': 0.0067, 'sample_count': 12000, 'changed': True}, gameOverVisualMetrics={'exists': True, 'width': 1206, 'height': 2622, 'sample_count': 40000, 'min_luma': 0.0, 'max_luma': 255.0, 'mean_luma': 43.155, 'dark_ratio': 0.4379, 'bright_ratio': 0.1373, 'very_bright_ratio': 0.0143, 'saturated_color_ratio': 0.3256, 'color_bucket_count': 120}, gameOverVisualStateVisible=False.
- qa_retry_visual_recovery_gate: retryProbePresent=True, screenState='gameplay', isGameOver=False, gameOverPanelVisible=False, gameOverToRetry={'comparable': True, 'mean_abs_diff': 0.46, 'changed_ratio': 0.0029, 'sample_count': 12000, 'changed': False}, retryVisualMetrics={'exists': True, 'width': 1206, 'height': 2622, 'sample_count': 40000, 'min_luma': 0.0, 'max_luma': 255.0, 'mean_luma': 43.189, 'dark_ratio': 0.4369, 'bright_ratio': 0.1368, 'very_bright_ratio': 0.0145, 'saturated_color_ratio': 0.3264, 'color_bucket_count': 118}, retryVisualStateVisible=False.
- qa_non_placeholder_visual_richness_gate: gameplayVisualMetrics={'exists': True, 'width': 1206, 'height': 2622, 'sample_count': 40000, 'min_luma': 0.0, 'max_luma': 255.0, 'mean_luma': 43.227, 'dark_ratio': 0.4374, 'bright_ratio': 0.1383, 'very_bright_ratio': 0.0143, 'saturated_color_ratio': 0.326, 'color_bucket_count': 124}, gameplayNonPlaceholderVisuals=False.
- playthrough_game_over_to_retry_changed: {'comparable': True, 'mean_abs_diff': 0.46, 'changed_ratio': 0.0029, 'sample_count': 12000, 'changed': False}
- qa_visual_richness_quality_gate: gameplayVisualsVerified=True, gameplayInstructionReadableVerified=True, videoExists=True, menuToGameplayChanged=True, gameplayToGameOverChanged=True, menuHumanReadable=False, gameplayNonPlaceholderVisuals=False, gameOverVisualStateVisible=False, retryVisualStateVisible=False, GameplayVisualsAreReadable=True.
