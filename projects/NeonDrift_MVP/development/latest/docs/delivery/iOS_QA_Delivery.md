...
- checks_failed: 9
- checks_blocked: 0
- bundle_id: com.DefaultCompany.NeonDrift.run.1782483119.37854

## iOS Simulator App

- app_path: `/home/node/.openclaw/workspace/382b9e3384298039b171c9b2a60ae644/NeonDrift_MVP/project/xcode_derived_data/Build/Products/Release-iphonesimulator/NeonDrift.run.1782483119.37854.app`

## Install And Launch

```bash
xcrun simctl install booted /Users/dragonkao/.openclaw/workspace/382b9e3384298039b171c9b2a60ae644/NeonDrift_MVP/project/xcode_derived_data/Build/Products/Release-iphonesimulator/NeonDrift.run.1782483119.37854.app
xcrun simctl launch booted com.DefaultCompany.NeonDrift.run.1782483119.37854
```
...
- qa_menu_human_readability_gate: menuVisualMetrics={'exists': True, 'width': 1206, 'height': 2622, 'sample_count': 40000, 'min_luma': 0.0, 'max_luma': 84.072, 'mean_luma': 32.893, 'dark_ratio': 0.4052, 'bright_ratio': 0.0002, 'very_bright_ratio': 0.0, 'saturated_color_ratio': 0.0162, 'color_bucket_count': 29}, menuHumanReadable=False.
- qa_game_over_visual_state_gate: gameOverProbePresent=True, screenState='game_over', isGameOver=True, gameOverPanelVisible=True, gameplayToGameOver={'comparable': True, 'mean_abs_diff': 1.603, 'changed_ratio': 0.009, 'sample_count': 12000, 'changed': True}, gameOverVisualMetrics={'exists': True, 'width': 1206, 'height': 2622, 'sample_count': 40000, 'min_luma': 0.0, 'max_luma': 255.0, 'mean_luma': 43.167, 'dark_ratio': 0.4378, 'bright_ratio': 0.1372, 'very_bright_ratio': 0.0145, 'saturated_color_ratio': 0.3256, 'color_bucket_count': 122}, gameOverVisualStateVisible=False.
- qa_non_placeholder_visual_richness_gate: gameplayVisualMetrics={'exists': True, 'width': 1206, 'height': 2622, 'sample_count': 40000, 'min_luma': 0.0, 'max_luma': 255.0, 'mean_luma': 43.231, 'dark_ratio': 0.4379, 'bright_ratio': 0.1389, 'very_bright_ratio': 0.0144, 'saturated_color_ratio': 0.3255, 'color_bucket_count': 123}, gameplayNonPlaceholderVisuals=False.
