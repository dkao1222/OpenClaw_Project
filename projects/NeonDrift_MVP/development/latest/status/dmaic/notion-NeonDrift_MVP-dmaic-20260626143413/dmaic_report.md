...
- run_id: notion-NeonDrift_MVP-dmaic-20260626143413
- source_pipeline: qa
- checks_total: 10
- checks_failed: 2
...
- | qa_menu_human_readability_gate | Visual | FAIL | menuVisualMetrics={'exists': True, 'width': 1206, 'height': 2622, 'sample_count': 40000, 'min_luma': 0.0, 'max_luma': 31.072, 'mean_luma': 30.702, 'dark_ratio': 0.012, 'bright_ratio': 0.0, 
- | qa_game_over_visual_state_gate | Visual | FAIL | gameOverProbePresent=True, screenState='game_over', isGameOver=True, gameOverPanelVisible=True, gameplayToGameOver={'comparable': True, 'mean_abs_diff': 0.937, 'changed_ratio': 0.0067, 'sam
- | qa_retry_visual_recovery_gate | Visual | FAIL | retryProbePresent=True, screenState='gameplay', isGameOver=False, gameOverPanelVisible=False, gameOverToRetry={'comparable': True, 'mean_abs_diff': 0.46, 'changed_ratio': 0.0029, 'sample_cou
- | qa_non_placeholder_visual_richness_gate | Visual | FAIL | gameplayVisualMetrics={'exists': True, 'width': 1206, 'height': 2622, 'sample_count': 40000, 'min_luma': 0.0, 'max_luma': 255.0, 'mean_luma': 43.227, 'dark_ratio': 0.4374, 'bright_
- | playthrough_game_over_to_retry_changed | Playthrough | FAIL | {'comparable': True, 'mean_abs_diff': 0.46, 'changed_ratio': 0.0029, 'sample_count': 12000, 'changed': False} | /home/node/.openclaw/workspace/382b9e3384298039b171c9b2a60ae644/
...
- | qa_retry_restarts_gameplay_gate | Gameplay | FAIL | retryRestartsGameplayVerified=True, RetryRestartsGameplay=True, gameOverToRetryChanged=False, retryVisualStateVisible=False. | /home/node/.openclaw/workspace/382b9e3384298039b171c9b2a60a
