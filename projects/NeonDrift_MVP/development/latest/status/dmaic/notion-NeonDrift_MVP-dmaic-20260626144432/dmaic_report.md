...
- run_id: notion-NeonDrift_MVP-dmaic-20260626144432
- source_pipeline: qa
- checks_total: 10
- checks_failed: 2
...
- | qa_game_over_visual_state_gate | Visual | FAIL | gameOverProbePresent=True, screenState='game_over', isGameOver=True, gameOverPanelVisible=True, gameplayToGameOver={'comparable': True, 'mean_abs_diff': 1.63, 'changed_ratio': 0.0077, 'samp
- | qa_retry_visual_recovery_gate | Visual | FAIL | retryProbePresent=True, screenState='gameplay', isGameOver=False, gameOverPanelVisible=False, gameOverToRetry={'comparable': True, 'mean_abs_diff': 0.083, 'changed_ratio': 0.0006, 'sample_co
- | playthrough_game_over_to_retry_changed | Playthrough | FAIL | {'comparable': True, 'mean_abs_diff': 0.083, 'changed_ratio': 0.0006, 'sample_count': 12000, 'changed': False} | /home/node/.openclaw/workspace/382b9e3384298039b171c9b2a60ae644
- | qa_visual_richness_quality_gate | Visual | FAIL | gameplayVisualsVerified=True, gameplayInstructionReadableVerified=True, videoExists=True, menuToGameplayChanged=True, gameplayToGameOverChanged=True, menuHumanReadable=True, gameplayNonPla
