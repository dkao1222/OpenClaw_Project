...
- define_page_id: 388b9e33-8429-81d6-a990-e712e1447db8
...
iOS 15+, iPhone SE 2/3, iPhone 12/13 mini, iPhone 15/15 Pro; safe-area, touch targets, reduced motion, and readable contrast required.

## Output Expectation

Every pipeline stage must publish to Notion and Git under one project folder, with bounded documents, explicit gates, handoffs, build instructions, QA test plan, QA report, and recorded evidence requirements.
