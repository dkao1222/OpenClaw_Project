...
run_id: notion-NeonDrift_MVP-0-12-20260711061329
chain_id: raw:NeonDrift_MVP:20260711060757
stage_range: 0-12
agent_model_policy: per-agent-config
legacy_model_field_ignored: per-agent-config
thinking: off
requested_by: define:notion-NeonDrift_MVP-define-20260711060933
...
Research Knowledge Capture Contract from Define: external research must be converted into source cards, license/usage risk, synthesis, and downstream citations before it can influence Planning, Spec Review, Development, or QA.
Idea Expansion Governance from Define: Planning must preserve the boundary between Confirmed Requirements, Interpretations, Expansion Candidates, Recommended, not confirmed direction, and Open Questions. Candidates may be explored, compared, combined, or rejected; they must not be treated as user-approved facts unless downstream approval evidence exists.
...
Required research markers: Research_Source_Cards.md, Research_Synthesis.md, Research_License_Risk_Register.md, source_card_id, source_url, accessed_at, license_or_terms, usage_risk, design_implication, do_not_use_directly.
Planning must read docs/define/Defined_Request.md, docs/define/Project_Input_Schema.md, docs/define/Pipeline_Gates.md, docs/define/Research_Knowledge_Cards.md, and handoffs/define/handoff_to_planning.md for full bounded context.
