...
- run_id: notion-NeonDrift_MVP-dmaic-20260626145042
- source_pipeline: qa
- checks_total: 10
- checks_failed: 2
...
- | qa_game_over_visual_state_gate | Visual | FAIL | gameOverProbePresent=True, screenState='game_over', isGameOver=True, gameOverPanelVisible=True, gameplayToGameOver={'comparable': True, 'mean_abs_diff': 1.591, 'changed_ratio': 0.0076, 'sam
- | qa_non_placeholder_visual_richness_gate | Visual | FAIL | gameplayVisualMetrics={'exists': True, 'width': 1206, 'height': 2622, 'sample_count': 40000, 'min_luma': 0.0, 'max_luma': 255.0, 'mean_luma': 53.195, 'dark_ratio': 0.4059, 'bright_
...
- QA status is failed. 6 checks failed and 0 checks are blocked.
- - status: failed
