...
- onboarding: 首局透過即時 feedback 說明 keyboard steering、boost、pause 與 restart 預期。
...
- onboarding: first session shows keyboard steering, boost, pause, and restart expectations through immediate feedback.
