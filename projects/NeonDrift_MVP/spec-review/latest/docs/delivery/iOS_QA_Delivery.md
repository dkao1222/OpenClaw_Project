...
- qa_retry_live_motion_after_retry_gate: retryProbePresent=True, retryLiveProbePresent=False, retryScreenState='gameplay', retryLiveScreenState=None, retryGameplayTime=0.8161333799362183, retryLiveGameplayTime=None, retryScore=7, retryLiveScore=None, retryLiveFps=None, retryLiveIsGameOver=None, retryLiveIsPaused=None, retryLiveGameOverPanelVisible=None, retryToRetryLive={'comparable': True, 'mean_abs_diff': 38.061, 'changed_ratio': 0.2456, 'sample_count': 12000, 'changed': True}, retryLiveVisualMetrics={'exists': True, 'width': 1206, 'height': 2622, 'sample_count': 40000, 'min_luma': 0.0, 'max_luma': 255.0, 'mean_luma': 59.387, 'dark_ratio': 0.3094, 'bright_ratio': 0.2581, 'very_bright_ratio': 0.0606, 'saturated_color_ratio': 0.6404, 'color_bucket_count': 171}, retryLiveMotionVerified=False.
