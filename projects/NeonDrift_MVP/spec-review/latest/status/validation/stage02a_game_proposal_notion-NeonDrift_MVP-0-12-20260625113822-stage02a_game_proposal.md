...
- session_id: notion-NeonDrift_MVP-0-12-20260625113822-stage02a_game_proposal
...
- FAIL file.length_contract.docs/planning/Game_Proposal.md: 4694 not in [700, 4600]
...
- FAIL file.length_contract.docs/planning/proposal/High_Concept.md: 3670 not in [900, 3400]
...
- PASS file.size_limit.docs/planning/proposal/Primary_Objects_and_Rules.md: 4240<=8000
...
- PASS file.length_contract.docs/planning/proposal/Primary_Objects_and_Rules.md: 3734
...
## Failures
- planning doc length contract failed: docs/planning/Game_Proposal.md: 4694 not in [700, 4600]
- planning doc length contract failed: docs/planning/proposal/High_Concept.md: 3670 not in [900, 3400]
